      ...
      <xsl:call-template name="mini-table">
        ...
        <xsl:with-param name="body">
          <codeph class="+ topic/ph pr-d/codeph ">
            ...
            <xsl:text
            >clone, equals, finalize, getClass, hashCode, notify, notifyAll, toString, wait, wait, wait</xsl:text>
          </codeph>
        </xsl:with-param>
      </xsl:call-template>
    </table>
      ...
      <xsl:call-template name="mini-table">
        ...
        <xsl:with-param name="body">
          <codeph class="+ topic/ph pr-d/codeph ">
            ...
            <xsl:text
            >addSuppressed, fillInStackTrace, getCause, getLocalizedMessage, getMessage, getStackTrace, getSuppressed, initCause, printStackTrace, printStackTrace, printStackTrace, setStackTrace, toString</xsl:text>
          </codeph>
        </xsl:with-param>
      </xsl:call-template>
    </table>
